...
const blackjackSessionsColumnData = [
  {
    Header: 'Table Id',
    accessor: 'id'
  },
      ...
      return (
        <>
          <MDBox sx={{ display: 'flex', justifyContent: 'space-around' }}>
            <Tooltip title='Edit'>
              <NavLink to={`/blackjack-sessions/${window.location.pathname.split('/')[2]}/edit/${row.original.id}`}>
...
export default blackjackSessionsColumnData;
