...
function EditBaccaratTable() {
  ...
  useEffect(() => {
    getBaccaratTable(id).then((response) => {
      const { data } = response;
      setInitialValues({
  ...
  const updateTable = async () => {
    try {
      await updateBaccaratTable({ tableId: id, minBet: initialValues.min_bet, maxBet: initialValues.max_bet });
...
export default EditBaccaratTable;
